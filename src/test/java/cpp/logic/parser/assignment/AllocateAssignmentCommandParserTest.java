...
public class AllocateAssignmentCommandParserTest {

    private AllocateAssignmentCommandParser parser = new AllocateAssignmentCommandParser();
    ...
    public void parse_allFieldsPresent_success() throws Exception {
        ...
        CommandParserTestUtil.assertParseSuccess(this.parser,
                ...
                new AllocateAssignmentCommand(sampleAssignment.getName(), new ArrayList<>(Arrays.asList(
        ...
        CommandParserTestUtil.assertParseSuccess(this.parser,
                ...
                new AllocateAssignmentCommand(sampleAssignment.getName(), new ArrayList<>(),

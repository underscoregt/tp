...
public class AllocateClassGroupCommandParserTest {

    private AllocateClassGroupCommandParser parser = new AllocateClassGroupCommandParser();
    ...
    public void parse_allFieldsPresent_success() throws Exception {
        ...
        CommandParserTestUtil.assertParseSuccess(this.parser,
                ...
                new AllocateClassGroupCommand(sampleClassGroup.getName(), new ArrayList<>(Arrays.asList(
